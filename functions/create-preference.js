// functions/create-preference.js - V32
// V32: removida oferta 'profissional-fidelidade-1mes' (R$75) - decisão Arthur 03/07/2026
// V31: removido default_payment_method_id (conflitava com excluded_payment_types)
...
export async function onRequest(context) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Falha de rede ao MP", details: String(err) }), { status: 500, headers: cors() });
  }
}
